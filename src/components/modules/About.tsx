import BentoGridCom from "../BentoGrid";
...
const About = () => {
  return (
    <div className="py-30">
      <SectionHeader title="About Me" description="Passionate software developer crafting scalable, user-friendly solutions. I turn complex challenges into clean, efficient code while constantly learning and innovating."/>
      
      <div className="container mx-auto">
        <div className="flex gap-5">
          <div className="flex-2">
            <img src={aboutImage} className="grayscale" alt="Nabil Siddik about" />
          </div>
          <div className="flex-3"><CoderProfileCard /></div>
        </div>
      </div>
    </div>
  )
