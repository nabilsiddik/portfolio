...
import developerImage from '../../assets/images/nabil-siddik-web-developer.png'
...
const GithubIcon = () => (
    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 496 512" height="27px" width="27px" xmlns="http://www.w3.org/2000/svg">
