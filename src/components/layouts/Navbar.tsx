...
const CodeIcon = () => (
    <svg fill="#000000" className="w-[26px] lg:w-[30px] xl:w-[35px]" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex h-16 items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-10">
                            {/* logo  */}
                            <Link to='/'>
                                <h2 className="font-bold text-lg md:text-xl lg:text-2xl flex items-center gap-2">
                                    <span className="mt-1">
                                        <CodeIcon />
                                    </span>
