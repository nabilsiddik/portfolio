...
export default function FancyTab() {
  ...
  return (
    <div className='w-full max-full mx-auto'>
      ...
      <div className='flex flex-col sm:flex-row gap-6 rounded-xl overflow-hidden'>
        ...
        {/* Content area */}
        <div className='flex-1 relative rounded-xl bg-white/80 dark:bg-gray-900/80 backdrop-filter backdrop-blur-lg shadow-lg overflow-hidden border-1'>
          {/* Loading overlay */}
          <AnimatePresence>
            {isLoading && (
              <motion.div
