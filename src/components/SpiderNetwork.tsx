...
import aboutProfile from '../assets/images/nabil-siddik-web-developer.png'
import { EducationSVGIcon, IdeaSVGIcon, LocationSVGIcon } from '@/svg/AboutIcons';
...
const IconGrid = () => {
    ...
    const outerIcons = useMemo((): OuterIcon[] => [
        { id: 1, component: <EducationSVGIcon/> },
        { id: 2, component: <IdeaSVGIcon /> },
        { id: 3, component: <LocationSVGIcon /> },
        ...
        <div className="relative w-[400px] h-[400px] scale-75 md:scale-90 lg:scale-100">
            ...
            <div className="absolute top-1/2 left-1/2">
                <div className="absolute -translate-x-1/2 -translate-y-1/2 z-20">
                    <IconWrapper className="w-30 h-30 p-4" isHighlighted={true}>
                        <img className='w-full' src={aboutProfile} alt="nabil siddik" />
                    </IconWrapper>
                </div>
...
export default function SpiderNetwork() {
  return (
