...
interface GlowButtonProps {
    ...
    variant?: "blue" | "pink" | "green" | "orange";
}
...
const variants = {
    ...
    orange: {
        light: {
            outerGlow: "rgba(227, 96, 11, 0.4)",
            blobGlow: "rgba(227, 96, 11, 0.6)",
            blobHighlight: "#E3600B",
            blobShadow: "rgba(227, 96, 11, 0.25)",
            innerGlow: "rgba(227, 96, 11, 0.1)",
            innerHighlight: "rgba(255, 179, 128, 0.15)",
            outerBg: "linear-gradient(135deg, #fffaf5 0%, #ffe9d6 100%)",
            innerBg: "linear-gradient(135deg, #ffffff 0%, #fff2e8 100%)",
            textColor: "#1e293b",
        },
        dark: {
            outerGlow: "rgba(255, 255, 255, 0.35)",
            blobGlow: "rgba(227, 96, 11, 0.5)",
            blobHighlight: "#ff944d",
            blobShadow: "rgba(227, 96, 11, 0.18)",
            innerGlow: "rgba(227, 96, 11, 0.07)",
            innerHighlight: "rgba(255, 179, 128, 0.1)",
            outerBg: "radial-gradient(circle 80px at 80% -10%, #ffffff, #1b1714)",
            innerBg: "radial-gradient(circle 80px at 80% -50%, #6b4a3b, #0f0c0a)",
            textColor: "#ffffff",
        },
    },
    pink: {
...
export default function CustomGlowButton({ text, icon }: IGlowButtonProps) {
    return (
        <GlowButton variant="orange">
